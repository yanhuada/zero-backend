...
public class CircleTopicContentSubComment extends BaseModelWithId implements Serializable {
    @ApiModelProperty(value="根评论ID")
    private Long circleTopicContentCommentId;
    ...
    public Long getCircleTopicContentCommentId() {
        return circleTopicContentCommentId;
    }

    public void setCircleTopicContentCommentId(Long circleTopicContentCommentId) {
        this.circleTopicContentCommentId = circleTopicContentCommentId;
    }
