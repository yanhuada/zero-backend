...
public class WeeklySubComment extends BaseModelWithId implements Serializable {
    @ApiModelProperty(value="根评论ID")
    private Long weeklyCommentId;
    ...
    public Long getWeeklyCommentId() {
        return weeklyCommentId;
    }

    public void setWeeklyCommentId(Long weeklyCommentId) {
